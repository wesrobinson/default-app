...
ActiveRecord::Schema.define(version: 20171007224856) do
  ...
  create_table "spree_option_type_prototypes", id: :bigserial, force: :cascade do |t|
  ...
  create_table "spree_option_value_variants", id: :bigserial, force: :cascade do |t|
    t.integer "variant_id"
  ...
  create_table "spree_order_promotions", id: :bigserial, force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "spree_product_promotion_rules", id: :bigserial, force: :cascade do |t|
    t.integer "product_id"
  ...
  create_table "spree_products_taxons", id: :bigserial, force: :cascade do |t|
    t.integer "product_id"
    t.integer "taxon_id"
    t.integer "position"
  ...
  create_table "spree_promotion_rule_users", id: :bigserial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "promotion_rule_id"
  ...
  create_table "spree_property_prototypes", id: :bigserial, force: :cascade do |t|
    t.integer "prototype_id"
    t.integer "property_id"
  ...
  create_table "spree_role_users", id: :bigserial, force: :cascade do |t|
    t.integer "role_id"
    t.integer "user_id"
  ...
  create_table "spree_shipping_method_zones", id: :bigserial, force: :cascade do |t|
